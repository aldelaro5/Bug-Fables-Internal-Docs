Seems to be a function that is called right at the end of the [dialogue cleanup phase](../Life%20Cycle/dialogue%20cleanup%20phase.md). It seems to handle very specific logic with flags:
