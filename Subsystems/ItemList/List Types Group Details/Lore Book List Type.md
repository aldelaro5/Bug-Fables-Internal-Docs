...
`listvar` is all the integers from 0 to the flagvar 15 subtracted by 1. In practice, this represents the numbers from 0 to the amount of lore book unlocked - 1.

`listredirect` is overridden to -66 which, corresponds to the CommonDialogue line 65 and has the following: `|tail,null||boxstyle,3||bleep,2,1,1||lore|`.

## Option's SetText input string

The text is the name of the lore book obtained from LoreText. If the option is `option`, flagstring 0 is set to the text of the lore book from LoreText.
