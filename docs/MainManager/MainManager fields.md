...
|preconfigjoy|int[]|Yes|No|Contains all valid [controller preset](../InputIO/Controllers.md#controller-binding-presets) ids used for the PauseMenu when rendering the settings window. The value is hardcoded to {0, 1, 2, 3, 4, 5, 6, 7, 8}|
|precjoystring|int[]|Yes|No|The `menutext` indexes of all the [controller presets](../InputIO/Controllers.md#controller-binding-presets)'s names in the settings ordered by their preset ids. The value is hardcoded to {225, 226, 227, 232, 233, 228, 229, 242, 269}|
