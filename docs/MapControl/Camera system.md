...
Most of the camera system is actually managed by MainManager via some fields that act as a state machine. More information can be found on the general [camera system](../General%20systems/Camera%20system.md) documentation.
