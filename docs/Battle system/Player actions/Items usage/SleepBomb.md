...
|-:|---|---|---|---|---|---|---|
|1|None|null|`availabletargets[target]`|5|[Sleep](../../Damage%20pipeline/AttackProperty.md)|empty array|false|
|2|Done for each enemy party member other than the `target` whose position + `freezeoffset` + their `height` in y has a square distance off the object after movement less than 15.5|null|The enemy party member|3|[Sleep](../../Damage%20pipeline/AttackProperty.md)|empty array|false|
