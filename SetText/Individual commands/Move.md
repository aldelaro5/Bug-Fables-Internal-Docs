...
The y position to move the `entity` to. The float form must be a valid float or an exception will be thrown. If the value is `null`, this will default to 0.0.
